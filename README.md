...
Note: This wrapper uses Promises, if they are not supported in your environment, you might want to add [a polyfill](https://github.com/stefanpenner/es6-promise) for them.
...
Import the module and create a new client. Passing an API key and secret is optional only if you don't plan on doing any authenticated calls. You can create an API key [here](https://www.binance.com/en-IN/support/faq/360002502072).
...
publicClient.public.spot.marketData.time().then(time => console.log(time))
```
...
Every REST method returns a Promise, making this library [async await](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function) ready. The following examples will use the `await` form, which requires some configuration that you will have to lookup.

### Table of Contents
- [Init](#init)
- [public](#public)
  - [spot](#public-spot)
    - [wallet](#public-spot-wallet)
      - [systemStatus](#public-spot-wallet-system-status)
    - [marketData](#public-spot-market-data)
      - [ping](#public-spot-market-data-ping)
      - [time](#public-spot-market-data-time)
      - [exchangeInfo](#public-spot-market-data-exchange-info)
      - [book](#public-spot-market-data-book)
      - [trades](#public-spot-market-trades)
      - [aggTrades](#public-spot-market-agg-trades)
      - [candles](#public-spot-market-candles)
      - [avgPrice](#public-spot-market-avg-price)
      - [dailyTickerStats](#public-spot-market-daily-ticker-stats)
      - [price](#public-spot-market-price)
      - [bookTicker](#public-spot-market-book-ticker)
  - [futures](#public-futures)
      - [ping](#public-futures-ping)
      - [time](#public-futures-time)
      - [exchangeInfo](#public-futures-exchange-info)
      - [book](#public-futures-book)
      - [trades](#public-futures-trades)
      - [aggTrades](#public-futures-agg-trades)
      - [candles](#public-futures-candles)
      - [continuousKlines](#public-futures-continuous-klines)
      - [indexPriceKlines](#public-futures-index-price-klines)
      - [markPriceKlines](#public-futures-mark-price-klines)
      - [markPrice](#public-futures-mark-price)
      - [fundingRateHistory](#public-futures-funding-rate-history)
      - [dailyTickerStats](#public-futures-daily-ticker-stats)
      - [price](#public-futures-price)
      - [bookTicker](#public-futures-book-ticker)
      - [openInterest](#public-futures-open-interest)
      - [openInterestHistory](#public-futures-open-interest-history)
      - [topLongShortPositionRatio](#public-futures-top-long-short-position-ratio)
      - [longShortRatio](#public-futures-long-short-ratio)
      - [takerBuySellVolume](#public-futures-taker-buy-sell-volume)
      - [historicalBLVTNAVKlines](#public-futures-historical-BLVT-NAV-klines)
      - [compositeIndexSymbolInfo](#public-futures-composite-index-symbol-info)
- [authenticated](#authenticated)
  - [spot](#authenticated-spot)
    - [wallet](#authenticated-spot-wallet)
      - [accountCoins](#authenticated-spot-wallet-account-coins)
      - [dailyAccountSnapshot](#authenticated-spot-wallet-daily-account-snapshot)
      - [disableFastWithdrawSwitch](#authenticated-spot-wallet-disable-fast-withdraw-switch)
      - [enableFastWithdrawSwitch](#authenticated-spot-wallet-enable-fast-withdraw-switch)
      - [withdraw](#authenticated-spot-wallet-withdraw)
      - [depositHistory](#authenticated-spot-wallet-deposit-history)
      - [withdrawHistory](#authenticated-spot-wallet-withdraw-history)
      - [depositAddress](#authenticated-spot-wallet-deposit-address)
      - [accountStatus](#authenticated-spot-wallet-account-status)
      - [accountAPITradingStatus](#authenticated-spot-wallet-account-API-trading-status)
      - [dustLog](#authenticated-spot-wallet-dust-log)
      - [dustTransfer](#authenticated-spot-wallet-dust-transfer)
      - [assetDividendRecord](#authenticated-spot-wallet-asset-dividend-record)
      - [assetDetail](#authenticated-spot-wallet-asset-detail)
      - [tradeFee](#authenticated-spot-wallet-trade-fee)
      - [universalTransfer](#authenticated-spot-wallet-universal-transfer)
      - [universalTransferHistory](#authenticated-spot-wallet-universal-transfer-history)
      - [fundingWallet](#authenticated-spot-wallet-funding-wallet)
      - [APIPermission](#authenticated-spot-wallet-API-permission)
      - [setAPIKeyIPRestriction](#authenticated-spot-wallet-set-API-key-IP-restriction)
      - [addIPListForAPIKey](#authenticated-spot-wallet-add-IP-list-for-API-key)
      - [getIPRestrictionForAPIKey](#authenticated-spot-wallet-get-IP-restriction-for-API-key)
      - [deleteIPListForAPIKey](#authenticated-spot-wallet-delete-IP-list-for-API-key)
    - [subAccount](#authenticated-spot-sub-account)
      - [createSubAccount](#authenticated-spot-sub-account-create-sub-account)
      - [list](#authenticated-spot-sub-account-list)
      - [spotAssetTransferHistory](#authenticated-spot-sub-account-spot-asset-transfer-history)
      - [futuresAssetTransferHistory](#authenticated-spot-sub-account-futures-asset-transfer-history)
      - [futuresAssetTransfer](#authenticated-spot-sub-account-futures-asset-transfer-history)
      - [getAssets](#authenticated-spot-sub-account-get-assets)
      - [summary](#authenticated-spot-sub-account-summary)
      - [getDepositAddress](#authenticated-spot-sub-account-get-deposit-address)
      - [getDepositHistory](#authenticated-spot-sub-account-get-deposit-history)
      - [status](#authenticated-spot-sub-account-status)
      - [enableMargin](#authenticated-spot-sub-account-enable-margin)
      - [getMarginAccountDetail](#authenticated-spot-sub-account-get-margin-account-detail)
      - [getMarginAccountSummary](#authenticated-spot-sub-account-get-margin-account-summary)
      - [enableFutures](#authenticated-spot-sub-account-enable-futures)
      - [getFuturesAccountDetail](#authenticated-spot-sub-account-get-futures-account-detail)
      - [getFuturesAccountSummary](#authenticated-spot-sub-account-get-futures-account-summary)
      - [getFuturesPositionRisk](#authenticated-spot-sub-account-get-futures-position-risk)
      - [futuresTransfer](#authenticated-spot-sub-account-futures-transfer)
      - [marginTransfer](#authenticated-spot-sub-account-margin-transfer)
      - [transferToSiblingSubAccount](#authenticated-spot-sub-account-transfer-to-sibling-sub-account)
      - [transferToMaster](#authenticated-spot-sub-account-transfer-to-master)
      - [transferHistory](#authenticated-spot-sub-account-transfer-history)
      - [universalTransfer](#authenticated-spot-sub-account-universal-transfer)
      - [universalTransferHistory](#authenticated-spot-sub-account-universal-transfer-history)
      - [getFuturesAccountDetailV2](#authenticated-spot-sub-account-get-futures-account-detail-V2)
      - [getFuturesAccountSummaryV2](#authenticated-spot-sub-account-get-futures-account-summary-V2)
      - [getFuturesPositionRiskV2](#authenticated-spot-sub-account-get-futures-position-risk-V2)
      - [enableBLVT](#authenticated-spot-sub-account-enable-BLVT)
      - [depositToManaged](#authenticated-spot-sub-account-deposit-to-managed)
      - [getManagedAccountDetails](#authenticated-spot-sub-account-get-managed-account-details)
      - [withdrawFromManaged](#authenticated-spot-sub-account-withdraw-from-managed)
    - [marketData](#authenticated-spot-market-data)
      - [historicalTrades](#authenticated-spot-market-data-historical-trades)
    - [trade](#authenticated-spot-trade)
      - [orderTest](#authenticated-spot-trade-order-test)
      - [order](#authenticated-spot-trade-order)
      - [cancelOrder](#authenticated-spot-trade-cancel-order)
      - [cancelOpenOrders](#authenticated-spot-trade-cancel-open-orders)
      - [getOrder](#authenticated-spot-trade-get-order)
      - [openOrders](#authenticated-spot-trade-open-orders)
      - [allOrders](#authenticated-spot-trade-all-orders)
      - [account](#authenticated-spot-trade-account)
      - [myTrades](#authenticated-spot-trade-my-trades)
      - [OCO](#authenticated-spot-trade-OCO)
        - [order](#authenticated-spot-trade-OCO-order)
        - [cancelOrder](#authenticated-spot-trade-OCO-cancel-order)
        - [getOrder](#authenticated-spot-trade-OCO-get-order)
        - [allOrders](#authenticated-spot-trade-OCO-all-orders)
        - [openOrders](#authenticated-spot-trade-OCO-open-orders)
    - [userDataStreams](#authenticated-spot-user-data-streams)
      - [create](#authenticated-spot-user-data-streams-create)
      - [ping](#authenticated-spot-user-data-streams-ping)
      - [close](#authenticated-spot-user-data-streams-close)
    - [savings](#authenticated-spot-savings)
      - [flexibleProduct](#authenticated-spot-savings-flexible-product)
        - [list](#authenticated-spot-savings-flexible-product-list)
        - [leftDailyPurchaseQuota](#authenticated-spot-savings-flexible-product-left-daily-purchase-quota)
        - [purchase](#authenticated-spot-savings-flexible-product-purchase)
        - [leftDailyRedemptionQuota](#authenticated-spot-savings-flexible-product-left-daily-redemption-quota)
        - [redeem](#authenticated-spot-savings-flexible-product-redeem)
        - [position](#authenticated-spot-savings-flexible-product-position)
      - [fixedActivityProject](#authenticated-spot-savings-fixed-activity-project)
        - [list](#authenticated-spot-savings-fixed-activity-project-list)
        - [purchase](#authenticated-spot-savings-fixed-activity-project-purchase)
        - [position](#authenticated-spot-savings-fixed-activity-project-position)
      - [lendingAccount](#authenticated-spot-savings-lending-account)
      - [purchaseRecord](#authenticated-spot-savings-purchase-record)
      - [redemptionRecord](#authenticated-spot-savings-redemption-record)
      - [interestHistory](#authenticated-spot-savings-interest-history)
      - [changeToDailyPosition](#authenticated-spot-savings-change-to-daily-position)
    - [mining](#authenticated-spot-mining)
      - [acquiringAlgorithm](#authenticated-spot-mining-acquiring-algorithm)
      - [acquiringCoinName](#authenticated-spot-mining-acquiring-coin-name)
      - [detailedMinerList](#authenticated-spot-mining-detailed-miner-list)
      - [minerList](#authenticated-spot-mining-miner-list)
      - [earningsList](#authenticated-spot-mining-earnings-list)
      - [extraBonusList](#authenticated-spot-mining-extra-bonus-list)
      - [hashrateResale](#authenticated-spot-mining-hashrate-resale)
        - [list](#authenticated-spot-mining-hashrate-resale-list)
        - [detail](#authenticated-spot-mining-hashrate-resale-detail)
        - [request](#authenticated-spot-mining-hashrate-resale-request)
        - [cancelConfiguration](#authenticated-spot-mining-hashrate-resale-cancel-configuration)
      - [staticList](#authenticated-spot-mining-static-list)
      - [accountList](#authenticated-spot-mining-account-list)
    - [futures](#authenticated-spot-futures)
      - [transfer](#authenticated-spot-futures-transfer)
      - [transactionHistoryList](#authenticated-spot-futures-transaction-history-list)
      - [crossCollateralBorrow](#authenticated-spot-futures-cross-collateral-borrow)
      - [crossCollateralBorrowHistory](#authenticated-spot-futures-cross-collateral-borrow-history)
      - [crossCollateralRepay](#authenticated-spot-futures-cross-collateral-repay)
      - [crossCollateralRepayHistory](#authenticated-spot-futures-cross-collateral-repay-history)
      - [crossCollateralWallet](#authenticated-spot-futures-cross-collateral-wallet)
      - [crossCollateralWalletV2](#authenticated-spot-futures-cross-collateral-wallet-V2)
      - [crossCollateralInformation](#authenticated-spot-futures-cross-collateral-information)
      - [crossCollateralInformationV2](#authenticated-spot-futures-cross-collateral-information-V2)
      - [crossCollateralCalculateRateAfterAdjust](#authenticated-spot-futures-cross-collateral-calculate-rate-after-adjust)
      - [crossCollateralCalculateRateAfterAdjustV2](#authenticated-spot-futures-cross-collateral-calculate-rate-after-adjust-V2)
      - [crossCollateralMaxAdjustAmount](#authenticated-spot-futures-cross-collateral-max-adjust-amount)
      - [crossCollateralMaxAdjustAmountV2](#authenticated-spot-futures-cross-collateral-max-adjust-amount-V2)
      - [adjustCrossCollateral](#authenticated-spot-futures-adjust-cross-collateral)
      - [adjustCrossCollateralV2](#authenticated-spot-futures-adjust-cross-collateral-V2)
      - [adjustCrossCollateralHistory](#authenticated-spot-futures-adjust-cross-collateral-history)
      - [crossCollateralLiquidationHistory](#authenticated-spot-futures-cross-collateral-liquidation-history)
      - [collateralRepayLimit](#authenticated-spot-futures-collateral-repay-limit)
      - [getCollateralRepayQuote](#authenticated-spot-futures-get-collateral-repay-quote)
      - [collateralRepay](#authenticated-spot-futures-collateral-repay)
      - [collateralRepaymentResult](#authenticated-spot-futures-collateral-repayment-result)
      - [crossCollateralInterestHistory](#authenticated-spot-futures-cross-collateral-interest-history)
    - [BLVT](#authenticated-spot-BLVT)
      - [info](#authenticated-spot-BLVT-info)
      - [subscribe](#authenticated-spot-BLVT-subscribe)
      - [getSubscriptionRecord](#authenticated-spot-BLVT-get-subscription-record)
      - [redeem](#authenticated-spot-BLVT-redeem)
      - [getRedemptionRecord](#authenticated-spot-BLVT-get-redemption-record)
      - [userLimit](#authenticated-spot-BLVT-user-limit)
    - [BSwap](#authenticated-spot-BSwap)
      - [getPools](#authenticated-spot-BSwap-get-pools)
      - [getLiquidity](#authenticated-spot-BSwap-get-liquidity)
      - [addLiquidity](#authenticated-spot-BSwap-add-liquidity)
      - [removeLiquidity](#authenticated-spot-BSwap-remove-liquidity)
      - [getLiquidityOperationRecords](#authenticated-spot-BSwap-get-liquidity-operation-records)
      - [requestQuote](#authenticated-spot-BSwap-request-quote)
      - [swap](#authenticated-spot-BSwap-swap)
      - [swapHistory](#authenticated-spot-BSwap-swap-history)
      - [getPoolConfigure](#authenticated-spot-BSwap-get-pool-configure)
      - [addLiquidityPreview](#authenticated-spot-BSwap-add-liquidity-preview)
      - [removeLiquidityPreview](#authenticated-spot-BSwap-remove-liquidity-preview)
    - [fiat](#authenticated-spot-fiat)
      - [getOrderHistory](#authenticated-spot-fiat-get-order-history)
      - [getPaymentHistory](#authenticated-spot-fiat-get-payment-history)
    - [C2C](#authenticated-spot-C2C)
      - [getTradeHistory](#authenticated-spot-C2C-get-trade-history)
    - [cryptoLoans](#authenticated-spot-crypto-loans)
      - [getCryptoLoansIncomeHistory](#authenticated-spot-crypto-loans-get-crypto-loans-income-history)
    - [pay](#authenticated-spot-pay)
      - [getPayTradeHistory](#authenticated-spot-pay-get-pay-trade-history)
  - [margin](#authenticated-margin)
    - [loan](#authenticated-margin-loan)
    - [repay](#authenticated-margin-repay)
    - [asset](#authenticated-margin-asset)
    - [allAssets](#authenticated-margin-all-assets)
    - [priceIndex](#authenticated-margin-price-index)
    - [order](#authenticated-margin-order)
    - [cancelOrder](#authenticated-margin-cancel-order)
    - [cancelAllOpenOrders](#authenticated-margin-cancel-all-open-orders)
    - [loanRecord](#authenticated-margin-loan-record)
    - [repayRecord](#authenticated-margin-repay-record)
    - [interestHistory](#authenticated-margin-interest-history)
    - [forceLiquidationRecord](#authenticated-margin-force-liquidation-record)
    - [getOrder](#authenticated-margin-get-order)
    - [openOrders](#authenticated-margin-open-orders)
    - [allOrders](#authenticated-margin-all-orders)
    - [myTrades](#authenticated-margin-my-trades)
    - [maxBorrow](#authenticated-margin-max-borrow)
    - [maxTransferOut](#authenticated-margin-max-transfer-out)
    - [setBNBBurn](#authenticated-margin-set-BNB-burn)
    - [getBNBBurn](#authenticated-margin-get-BNB-burn)
    - [interestRateHistory](#authenticated-margin-interest-rate-history)
    - [userDataStreams](#authenticated-margin-user-data-streams)
      - [create](#authenticated-margin-user-data-streams-create)
      - [ping](#authenticated-margin-user-data-streams-ping)
      - [close](#authenticated-margin-user-data-streams-close)
    - [cross](#authenticated-margin-cross)
      - [transfer](#authenticated-margin-cross-transfer)
      - [pair](#authenticated-margin-cross-pair)
      - [allPairs](#authenticated-margin-cross-all-pairs)
      - [transferHistory](#authenticated-margin-cross-transfer-history)
      - [account](#authenticated-margin-cross-account)
    - [isolated](#authenticated-margin-isolated)
      - [transfer](#authenticated-margin-isolated-transfer)
      - [transferHistory](#authenticated-margin-isolated-transfer-history)
      - [account](#authenticated-margin-isolated-account)
      - [disableAccount](#authenticated-margin-isolated-disable-account)
      - [enableAccount](#authenticated-margin-isolated-enable-account)
      - [enabledAccountLimit](#authenticated-margin-isolated-enabled-account-limit)
      - [symbol](#authenticated-margin-isolated-symbol)
      - [allSymbols](#authenticated-margin-isolated-all-symbols)
      - [userDataStreams](#authenticated-margin-isolated-user-data-streams)
        - [create](#authenticated-margin-isolated-user-data-streams-create)
        - [ping](#authenticated-margin-isolated-user-data-streams-ping)
        - [close](#authenticated-margin-isolated-user-data-streams-close)
    - [OCO](#authenticated-margin-OCO)
      - [order](#authenticated-margin-OCO-order)
      - [cancelOrder](#authenticated-margin-OCO-cancel-order)
      - [getOrder](#authenticated-margin-OCO-get-order)
      - [allOrders](#authenticated-margin-OCO-all-orders)
      - [openOrders](#authenticated-margin-OCO-open-orders)
  - [futures](#authenticated-futures)
    - [marketData](#authenticated-futures-market-data)
      - [historicalTrades](#authenticated-futures-market-data-historical-trades)
      - [topLongShortAccountRatio](authenticated-futures-market-data-top-long-short-account-ratio)
    - [trade](#authenticated-futures-trade)
      - [changePositionMode](#authenticated-futures-trade-change-position-mode)
      - [positionMode](#authenticated-futures-trade-position-mode)
      - [changeMultiAssetsMode](#authenticated-futures-trade-change-multi-assets-mode)
      - [multiAssetsMode](#authenticated-futures-trade-multi-assets-mode)
      - [order](#authenticated-futures-trade-order)
      - [batchOrder](#authenticated-futures-trade-batch-order)
      - [getOrder](#authenticated-futures-trade-get-order)
      - [cancelOrder](#authenticated-futures-trade-cancel-order)
      - [cancelOpenOrders](#authenticated-futures-trade-cancel-open-orders)
      - [cancelMultipleOrders](#authenticated-futures-trade-cancel-multiple-orders)
      - [autoCancelOpenOrders](#authenticated-futures-trade-auto-cancel-open-orders)
      - [getOpenOrder](#authenticated-futures-trade-get-open-order)
      - [openOrders](#authenticated-futures-trade-open-orders)
      - [allOrders](#authenticated-futures-trade-all-orders)
      - [accountBalance](#authenticated-futures-trade-account-balance)
      - [account](#authenticated-futures-trade-account)
      - [changeLeverage](#authenticated-futures-trade-change-leverage)
      - [changeMarginType](#authenticated-futures-trade-change-margin-type)
      - [modifyPositionMargin](#authenticated-futures-trade-modify-position-margin)
      - [positionMarginChangeHistory](#authenticated-futures-trade-position-margin-change-history)
      - [position](#authenticated-futures-trade-position)
      - [trades](#authenticated-futures-trade-trades)
      - [incomeHistory](#authenticated-futures-trade-income-history)
      - [leverageBracket](#authenticated-futures-trade-leverage-history)
      - [positionADLQuantileEstimation](#authenticated-futures-trade-position-ADL-quantile-estimation)
      - [getForceOrders](#authenticated-futures-trade-get-force-orders)
      - [APITradingQuantitativeRulesIndicators](#authenticated-futures-trade-API-trading-quantitative-rules-indicators)
      - [commissionRate](#authenticated-futures-trade-commission-rate)
    - [userDataStreams](#authenticated-futures-user-data-streams)
      - [create](#authenticated-futures-user-data-streams-create)
      - [ping](#authenticated-futures-user-data-streams-ping)
      - [close](#authenticated-futures-user-data-streams-close)
- [common](#common)
  - [getInfo](#common-get-info)
- [advanced](#advanced)
  - [publicRequest](#advanced-public-request)
  - [partialPrivateRequest](#advanced-partial-private-request)
  - [privateRequest](#advanced-private-request)
- [ws](#ws)
  - [spot](#ws-spot)
    - [aggTrades](#ws-spot-agg-trades)
    - [trades](#ws-spot-trades)
    - [candles](#ws-spot-candles)
    - [miniTicker](#ws-spot-mini-ticker)
    - [allMiniTickers](#ws-spot-all-mini-tickers)
    - [ticker](#ws-spot-ticker)
    - [allTickers](#ws-spot-all-tickers)
    - [bookTicker](#ws-spot-book-ticker)
    - [allBookTickers](#ws-spot-all-book-tickers)
    - [partialDepth](#ws-spot-partial-depth)
    - [depth](#ws-spot-depth)
    - [user](#ws-spot-user)
  - [margin](#ws-margin)
    - [user](#ws-margin-user)
  - [futures](#ws-futures)
    - [aggTrades](#ws-futures-agg-trades)
    - [markPrice](#ws-futures-mark-price)
    - [allMarkPrices](#ws-futures-all-mark-prices)
    - [candles](#ws-futures-candles)
    - [continuousKlines](#ws-futures-continuous-klines)
    - [miniTicker](#ws-futures-mini-ticker)
    - [allMiniTickers](#ws-futures-all-mini-tickers)
    - [ticker](#ws-futures-ticker)
    - [allTickers](#ws-futures-all-tickers)
    - [bookTicker](#ws-futures-book-ticker)
    - [allBookTickers](#ws-futures-all-book-tickers)
    - [liquidation](#ws-futures-liquidation)
    - [allLiquidations](#ws-futures-all-liquidations)
    - [partialDepth](#ws-futures-partial-depth)
    - [depth](#ws-futures-depth)
    - [BLVT](#ws-futures-BLVT)
      - [info](#ws-futures-BLVT-info)
      - [candles](#ws-futures-BLVT-candles)
    - [compositeIndex](#ws-futures-composite-index)
    - [user](#ws-futures-user)
  - [advanced](#ws-advanced)
    - [spot](#ws-advanced-spot)
      - [customSubStream](#ws-advanced-spot-custom-sub-stream)
    - [futures](#ws-advanced-futures)
      - [customSubStream](#ws-advanced-spot-custom-sub-stream)
